...
<template>
    <div class="bg-bc-black w-[382px] h-[523px] rounded-[35px] overflow-hidden">
        <!-- Upper Container -->
        <div class="w-full h-[190px]">
            <!-- Carousel Here -->
            <div class="relative h-full w-full flex overflow-hidden" v-if="posts.length">
                <button @click="prevImage" class="border-bc-yellow border-[1px] absolute z-10 top-1/2 left-0 ml-8 transform -translate-y-1/2 p-2 bg-bc-black-opacity rounded-full text-bc-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                </button>
                <button @click="nextImage" class="border-bc-yellow border-[1px] absolute z-10 top-1/2 right-0 mr-8 transform -translate-y-1/2 p-2 bg-bc-black-opacity rounded-full text-bc-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">

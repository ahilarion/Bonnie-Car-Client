...
<template>
  <div class="bg-bc-black w-full rounded-[35px] overflow-hidden">
    ...
    <!-- Lower Container -->
    <div class="font-bold w-full bg-white px-8">
      <h2 class="text-3xl text-center py-5 text-bc-white">
        Titre de l'annonce fzfq zfzq qzf qzfqz s
      </h2>
...
export default {
  ...
  methods: {
    nextImage() {
      this.currentImage =
        this.currentImage === this.posts.length - 1 ? 0 : this.currentImage + 1;
    },
    prevImage() {
      this.currentImage =
        this.currentImage === 0 ? this.posts.length - 1 : this.currentImage - 1;
    },
  },
};
</script>
